...
[CustomEditor(typeof(IKCalculator))]
public class SimpleIKSolverEditor : Editor
{
    ...
    static void OnDrawGizmosSelected(IKCalculator siks, GizmoType gizmoType)
    {
    ...
    {
        var siks = target as IKCalculator;
